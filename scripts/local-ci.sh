...
# 本地执行 Rust + TypeScript + Python + 混沌压测 + 跨语言一致性 (CTS) 全套测试
...
# 2. Rust Workspace 编译、单测、混沌套件与 CTS
echo "🦀 [2/5] 运行 Rust 全工作区单测、混沌压力注入与 CTS 审计..."
cargo test --workspace --quiet
echo "✅ Rust 核心、守护服务、混沌套件与 CTS 100% PASS"

# 3. TypeScript SDK 单元测试与 CTS
echo "⚛️  [3/5] 运行 TypeScript SDK 跨平台客户端与 CTS 测试..."
